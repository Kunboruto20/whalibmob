...
class SignalProtocol {
  ...
  _senderKeyName(groupId, senderId) {
    ...
    // device index the way Baileys and whatsmeow do — otherwise two devices of
    // the same person share one slot and the second one to speak overwrites
    // the first, leaving its messages undecryptable.
    //
