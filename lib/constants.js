...
// Version the companion announces. Unlike the mobile version this is not tied
// to an App Store build — it is the web client release, and the server is
// tolerant of a slightly stale one.
const WEB_VERSION_FALLBACK = [2, 3000, 1027934701];
