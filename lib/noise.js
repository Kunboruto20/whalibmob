    ...
    try {
      ...
      if (this._awaitingAuth) {
        ...
        if (tag === 'failure') {
          ...
          //
          // The names and numbers are whatsmeow's ConnectFailureReason, which
          // is the only place they are written down — WhatsApp publishes none
          // of this. Codes marked "wipe" are the ones its IsLoggedOut() covers:
          // the session is finished and retrying with it is pointless.
          const FAILURE = {
