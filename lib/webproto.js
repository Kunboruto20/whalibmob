...
// Exactly the fields the web client sets, and no others. `manufacturer` is
// deliberately absent: the reference never populates it for a web UserAgent,
// and an extra field is a difference the server can notice.
