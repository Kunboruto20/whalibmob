//
// iOS App Attest (DeviceCheck) middleware (Frida).
//
// Ported into whalibmob from Auties00/Cobalt
// (tools/mobile/ios/frida-scripts/integrity/server.js), MIT licensed,
// Copyright (c) 2021 Alessandro Autiero. See ../../README.md.
//
// Endpoint exposed on the device:
//   GET /integrity?authKey=<base64> -> { attestation, assertion }
