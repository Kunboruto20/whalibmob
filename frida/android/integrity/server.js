//
// Android Play Integrity + Keystore attestation middleware (Frida).
//
// Ported into whalibmob from Auties00/Cobalt
// (tools/mobile/android/frida-scripts/integrity/server.js), MIT licensed,
// Copyright (c) 2021 Alessandro Autiero. See ../../README.md for how
// whalibmob consumes the local HTTP server this script exposes
// (port 1119 = WhatsApp, 1120 = WhatsApp Business).
//
// Endpoints exposed on the device:
//   GET /info                       -> device/apk descriptor
//   GET /integrity?authKey=<b64url> -> { token }  (Play Integrity verdict = gpia)
//   GET /cert?authKey=<b64>&enc=<b64url> -> { signature, certificate }
//
